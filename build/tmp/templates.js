...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("src/app/home/home.tpl.html",
    ...
    "        <p class=\"range-field\">\n" +
    "          <input type=\"range\" id=\"fond\" min=\"0\" max=\"10\" />\n" +
    "        </p>\n" +
...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("src/app/home/home.tpl.html",
    ...
    "\n" +
    "      <li>\n" +
    "        <div class=\"collapsible-header\"><i class=\"material-icons\">filter_drama</i>1. Motif de la consultation</div>\n" +
    "        <div class=\"collapsible-body\">\n" +
    "          <div class=\"row\">\n" +
    "            <div class=\"input-field col s12\">\n" +
    "              <textarea id=\"douleur\" class=\"materialize-textarea\"></textarea>\n" +
    ...
    "\n" +
    "    <li>\n" +
    "      <div class=\"collapsible-header\"><i class=\"material-icons\">filter_drama</i>2. Evaluation de la douleur</div>\n" +
    "      <div class=\"collapsible-body\">\n" +
    "\n" +
    "        <!--CANVAS-->\n" +
    "        <div class=\"row\">\n" +
    ...
    "        </li>\n" +
    "        <li>\n" +
    "          <div class=\"collapsible-header\"><i class=\"material-icons\">filter_drama</i>3. Environnement <input type=\"checkbox\" class=\"filled-in\" id=\"negatif\" />\n" +
    "            <label for=\"negatif\">Négatif</label>\n" +
    "            <input type=\"checkbox\" class=\"filled-in\" id=\"non\" />\n" +
    "            <label for=\"non\">Non renseigné</label>\n" +
    "          </div>\n" +
