...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("src/common/header.tpl.html",
    ...
    "            <li><a id=\"loginButton\" class=\"waves-effect waves-light btn light-blue darken-3\"\n" +
...
module.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("src/app/home/home.tpl.html",
    ...
    "\n" +
    "          <p>Souffrez-vous du syndrome d'apnées/hypopnées obstructives du sommeil ?\n" +
    "            <input class=\"with-gap\" name=\"group1\" type=\"radio\" id=\"oui4\" ng-model=\"form.Radio5ApneOui\"/>\n" +
    "            <label for=\"oui4\">Oui</label>\n" +
    "            <input class=\"with-gap\" name=\"group1\" type=\"radio\" id=\"non4\" ng-model=\"form.Radio5ApneNon\"/>\n" +
    "            <label for=\"non4\">Non</label>\n" +
    "          </p>\n" +
    "\n" +
    "          <div class=\"row\">\n" +
